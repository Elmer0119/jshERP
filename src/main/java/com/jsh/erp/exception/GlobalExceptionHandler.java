...
import com.jsh.erp.utils.JsonUtils;
...
public class GlobalExceptionHandler {
    ...
    public Object handleException(Exception e, HttpServletRequest request) {
        ...
        // 针对业务参数异常的处理
        if (e instanceof JsonUtils.BusinessParamCheckingException) {
            status.put(ExceptionConstants.GLOBAL_RETURNS_CODE, ((JsonUtils.BusinessParamCheckingException) e).getCode());
            status.put(ExceptionConstants.GLOBAL_RETURNS_MESSAGE, ((JsonUtils.BusinessParamCheckingException) e).getReason());
            return status;
        }
